...
const Blogs = () => {
  ...
  const blogsData = [
    { title: 'The Benefits of Outsourcing Your Supply Chain to a 3PL Provider', body: 'In today’s competitive business environment, companies are constantly seeking ways to optimize their supply chain operations and gain a strategic advantage. One increasingly popular solution is.....' },
    { title: 'Understanding 3PL: What It Is and Why Your Business Needs It', body: 'In today’s fast-paced business landscape, companies are constantly seeking ways to streamline their operations and gain a competitive edge. One solution that..... ' },
    ...
    { title: 'The Role of Technology in Modern Warehousing Solutions', body: 'In today’s fast-paced business environment, technology plays a critical role in optimizing supply chain performance and driving success in the third-party logistics (3PL) industry. From warehouse management systems to.....' },
    ...
    { title: 'Case Study: Successful 3PL Implementation for a Retail Business', body: 'In today’s fast-paced retail environment, efficient logistics operations are crucial for success. A recent case study highlights how a leading retail brand transformed its supply chain by partnering with.....' },
    ...
    { title: 'Understanding the Role of 3PL in E-commerce Growth', body: 'In today’s fast-paced world, e-commerce is growing rapidly. One important player in this growth is third-party logistics (3PL). 3PL providers help online businesses manage their logistics, allowing them to focus on.....' },
